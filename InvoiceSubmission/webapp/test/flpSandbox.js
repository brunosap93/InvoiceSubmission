		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#InvoiceSubmission-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"InvoiceSubmission-display": {
								"semanticObject": "InvoiceSubmission",
								"action": "display",
								"description": "Create and send supplier invoices",
								"title": "Invoice Submission",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.InvoiceSubmission",
									"url": sap.ui.require.toUrl("ns/InvoiceSubmission")
								}
							}
						}
					}
