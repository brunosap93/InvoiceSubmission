sap.ui.define([
    ...
    return BaseController.extend("ns.InvoiceSubmission.controller.Object", {
        ...
        _loadPurchaseOrders: function () {
            ...
            $.ajax({
                type: "GET",
                url: "/<<app router path>>/ProcurementService/browse/PurchaseOrder?$filter=Status eq 'Pending' and Supplier eq 'USSU-VSF63'&$expand=To_PurchaseOrderItems($orderby=PurchaseOrderItem asc;$filter=Status eq 'Pending')",
                cache: false,
                dataType: "json",
                async: false,
        ...
        onSubmitInvoice : function()
        {
            ...
            if(isPO)
            {
                ...
                $.ajax({
                    type: "POST",
                    url: "/<<app router path>>/BUSINESS_RULES/rules-service/rest/v2/workingset-rule-services",
                    cache: false,
                    dataType: "json",
        ...
        closeItems: function(ID,Status)
        {
            ...
            $.ajax({
                    type: "PATCH",
                    url: "/<<app router path>>/ProcurementService/browse/PurchaseOrderItems("+ID+")",
                    cache: false,
                    dataType: "json",
                    headers: {"Content-Type":"application/json"},
                    data : data,
        ...
        triggerWorkflow: function(context)
        {
            ...
            $.ajax({
                    type: "POST",
                    url: "/<<app router path>>/workflowService/workflow-service/rest/v1/workflow-instances",
                    cache: false,
                    dataType: "json",
                    headers: {"Content-Type":"application/json"},
                    data : context,
